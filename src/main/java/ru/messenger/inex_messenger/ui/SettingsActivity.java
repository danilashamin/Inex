...
import ru.messenger.inex_messenger.services.ExportLogsService;
...
public class SettingsActivity extends XmppActivity implements
	...
	public void onStart() {
		...
		boolean removeLocation = new Intent("ru.messenger.inex_messenger.location.request").resolveActivity(getPackageManager()) == null;
