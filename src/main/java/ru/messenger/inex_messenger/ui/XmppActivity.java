...
import ru.messenger.inex_messenger.entities.Presences;
import ru.messenger.inex_messenger.services.AvatarService;
...
import ru.messenger.inex_messenger.services.XmppConnectionService.XmppConnectionBinder;
...
public abstract class XmppActivity extends Activity {
	...
	protected int mColorLightGreen;
...
//				startActivity(new Intent(this, MysqlTestActivity.class));
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mColorLightGreen = getResources().getColor(R.color.green200);
	...
	protected boolean usingEnterKey() {
		return getPreferences().getBoolean("display_enter_key", true);
	}
	...
	protected void inviteToConversation(Conversation conversation) {
		...
		intent.putExtra("inex", conversation.getUuid());
	...
	// TODO: KAV showAddToRosterDialog
	...
	public int getLightGreenColor() {
		return this.mColorLightGreen;
	}
			...
			nfcAdapter.setNdefPushMessageCallback(new NfcAdapter.CreateNdefMessageCallback() {
				...
				public NdefMessage createNdefMessage(NfcEvent nfcEvent) {
					return new NdefMessage(new NdefRecord[]{
							...
							NdefRecord.createApplicationRecord("ru.messenger.inex_messenger")
					});
				}
			}, this);
		}
	...
	public static class ConferenceInvite {
		...
		public static ConferenceInvite parse(Intent data) {
			...
			invite.uuid = data.getStringExtra("inex");
			if (invite.uuid == null) {
				return null;
			}
			try {
