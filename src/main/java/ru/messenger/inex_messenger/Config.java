...
public final class Config {
	...
	public static final String LOGTAG = "inex";



	public static final String DOMAIN_LOCK = null; //only allow account creation for this domain

	public static final String MAGIC_CREATE_DOMAIN = "messenger.pirogov-center.ru";
	public static final String MAGIC_CREATE_IDENTYFY = "INEX";

	public static final String BUG_REPORTS = "bugs@"+MAGIC_CREATE_DOMAIN;
	public static final boolean DISALLOW_REGISTRATION_IN_UI = false; //hide the register checkbox

	public static final boolean ALLOW_NON_TLS_CONNECTIONS = false; //very dangerous. you should have a good reason to set this to true
	public static final boolean FORCE_ORBOT = false; // always use TOR
	public static final boolean HIDE_MESSAGE_TEXT_IN_NOTIFICATION = false;
	public static final boolean SHOW_CONNECTED_ACCOUNTS = true; // TODO kav show number of connected accounts in foreground notification
	public static final boolean SHOW_DISABLE_FOREGROUND = true; //TODO kav if set to true the foreground notification has a button to disable it

	public static final boolean ALWAYS_NOTIFY_BY_DEFAULT = true; //TODO kav
	...
	public static final int REFRESH_UI_INTERVAL = 1000; //TODO kav 500
